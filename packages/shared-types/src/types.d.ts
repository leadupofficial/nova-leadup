...
export type AppEventType = 'conversation.created' | 'conversation.message' | 'recording.started' | 'recording.completed' | 'task.created' | 'task.updated' | 'task.completed' | 'reminder.triggered' | 'reminder.acknowledged' | 'memory.proposed' | 'memory.approved' | 'privacy.export_requested' | 'privacy.export_completed' | 'privacy.deletion_requested' | 'privacy.deletion_completed' | 'privacy.consent_changed' | 'retention.cleanup_completed' | 'translation.completed';
...
export type AvatarState = 'idle' | 'listening' | 'thinking' | 'speaking' | 'success' | 'warning' | 'offline' | 'recording';
export type Emotion = 'neutral' | 'happy' | 'curious' | 'focused' | 'concerned' | 'excited';
export type Viseme = 'silence' | 'PP' | 'FF' | 'TH' | 'DD' | 'kk' | 'CH' | 'SS' | 'nn' | 'RR' | 'aa' | 'E' | 'ih' | 'oh' | 'ou';
