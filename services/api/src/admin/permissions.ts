...
export const PERMISSION_METADATA: readonly PermissionDescriptor[] = [
	...
	{ permission: 'tasks.read', group: 'Assistant', label: 'Read tasks', description: 'View tasks with status, priority and due date.', dangerous: false },
	...
	{ permission: 'reminders.read', group: 'Assistant', label: 'Read reminders', description: 'View reminders and their execution history.', dangerous: false },
	...
	{ permission: 'memory.read', group: 'Assistant', label: 'Read memory', description: 'View stored memory entries. Personal data.', dangerous: false },
